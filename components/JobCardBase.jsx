...
export default function JobCardBase(props) {
    return (
        <div className="bg-white rounded-[6px] px-8 py-8 cursor-pointer lg:max-w-md max-w-full relative mt-8 sm:mx-auto sm:w-full hover:transition-all hover:delay-100 hover:duration-500 hover:scale-110">
